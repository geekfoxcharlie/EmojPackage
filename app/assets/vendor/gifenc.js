...
function encodeImageDescriptor(stream, width, height, localPalette, x = 0, y = 0) {
  stream.writeByte(44);
...
window.GIFEncoder = exports.GIFEncoder;
window.quantize = exports.quantize;
window.applyPalette = exports.applyPalette;
window.nearestColor = exports.nearestColor;
